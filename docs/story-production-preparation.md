...
[The exact production workflow](https://github.com/LaykenV/public-parish/actions/runs/34174377315)
and independent `npm run smoke:production` passed on that commit.

The smoke covered the direct Convex site, canonical domain, apex redirect,
...
three Boyce snapshots already matched production and were reused. Three official
document images passed byte checks. Boyce's existing atomic publication keys
were resolved through explicit target mappings and exact payload hashes.

| Story | Draft hash | Target review |
| --- | --- | --- |
| Meta lead | `c273cc25224077a6a4d4fd5ed437a3f27841f33ab0007e2248fe2982aa519a1e` | LIMITED, 21 supported checks |
| SpaceX secondary | `ed3c898498ddbb0b6780c4b0664adf5bc61876d928567a3ce75c55c34d5c80b0` | LIMITED, 26 supported checks |
| Boyce secondary | `9af5adfe26dc84a6188de8d74f98e9e3ee06babb3e1665948ef57f6bffd7394d` | LIMITED, 21 supported checks |
...
deployment site. It leaves the public custom domain and auth routing unchanged.
The initial failed attempt inserted no snapshot; its two uploaded blobs were
inventoried and reused. No production database copy or broad monitoring was used.
