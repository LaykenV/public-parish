...
import { signArtifactPacket, verifyArtifactPacket } from './transferContract'
...
export const exportDraft = query({
  ...
  handler: async (ctx, args) => {
    ...
    const value = { contract: 'story-retained-draft-v1' as const, originSite: env.CONVEX_SITE_URL, targetSite: args.targetSite, exportedAt: Date.now(),
